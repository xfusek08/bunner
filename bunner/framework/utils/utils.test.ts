...
describe('string', () => {
    describe('visualLength', () => {
        ...
        test('mixed content strings', () => {
            ...
            expect(visualLength('\x1b[31mred\x1b[0m\x1b[32mgreen\x1b[0m')).toBe(
                8,
            );
            expect(visualLength('start\x1b[31m red middle\x1b[0m end')).toBe(
                20,
            );
        });
        test('multiple ANSI codes in sequence', () => {
            expect(visualLength('\x1b[1m\x1b[31m\x1b[42mcomplex\x1b[0m')).toBe(
                7,
            );
